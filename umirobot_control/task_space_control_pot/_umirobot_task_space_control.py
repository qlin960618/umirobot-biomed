...
from umirobot_control.task_space_control_pot._umirobot_task_space_controller import UMIRobotTaskSpaceController
...
def get_xd_from_real_master(potentiometer_values, x_init):
    ...
    # One way of doing it
    normalized_potentiometer_values = normalize_potentiometer_values(potentiometer_values)
    tx = normalized_potentiometer_values[0] * 0.1 * i_  # +- 2 cm motion about x
    ty = normalized_potentiometer_values[1] * 0.1 * j_  # +- 2 cm motion about y
    tz = normalized_potentiometer_values[2] * 0.1 * k_  # +- 2 cm motion about z
